...
5. A plan with no `## Proposed Changes` heading is not template-shaped — the budget above would read as `6 + 0`. Count its top-level change sections instead, never zero.
