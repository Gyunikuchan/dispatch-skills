...
`--response-schema-file "<skills-dir>/dispatch-code-review/references/report-schema.json"` to every
...
`node <skills-dir>/dispatch-code-review/scripts/parse-report.mjs --file "<path>"`, then delete it.
