 ...
 * session logging and banners, delegate capture, and failure classification with model cascade.
 *
...
export function parseCommonArgs(argv, { booleanFlags = [], valueFlags = [] } = {}) {
  ...
  if (options.promptFile) {
    // Additive flag used by review/fill-template.mjs and review preparation:
