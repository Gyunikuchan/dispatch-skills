 ...
 * Mirrors runners/claude.mjs/runners/copilot.mjs MODE_DEFINITIONS; unlike those runners, opencode does
...
export function getOpencodeEnv(settings) {
  ...
  // matching how runners/claude.mjs/runners/agy.mjs/runners/copilot.mjs let their delegates reach their
...
Usage:
  node scripts/runners/opencode.mjs [options] [prompt]
...
Examples:
  node scripts/runners/opencode.mjs "Review git diff for bugs"
  node scripts/runners/opencode.mjs -a delegate "Inspect codebase structure"
  node scripts/runners/opencode.mjs -v "Inspect codebase structure"
  git diff | node scripts/runners/opencode.mjs "Analyze these changes"
  node scripts/runners/opencode.mjs -f CONTEXT.md "Summarize invariants"
  node scripts/runners/opencode.mjs -m anthropic/claude-opus-5 "Review this diff"
`);
}
