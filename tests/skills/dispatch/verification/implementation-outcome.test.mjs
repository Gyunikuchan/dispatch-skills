...
} from '../../../../skills/dispatch/scripts/verification/implementation-outcome.mjs';
...
describe('parseImplementationOutcome input', () => {
  it('fails closed on malformed input', () => {
    assert.throws(() => parseImplementationOutcome('not json'), /terminal envelope/i);
  });
});
