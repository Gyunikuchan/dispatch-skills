...
import { drive, implementationOutcome, makeGitRepo, runDispatch, parseAction, PLAN_BODY } from './driver-harness.mjs';
...
const config = {
  ...
  'write-subagents': { claude: { model: ['first-model'], effort: 'low' } },
