...
import { KNOWN_PROVIDERS } from '../../../../skills/dispatch/scripts/lib/providers.mjs';
import * as common from '../../../../skills/dispatch/scripts/lib/platform.mjs';
import {
  LEVELS,
  loadDispatchConfig,
  phaseMembers,
...
describe('lib/platform.mjs does not own dispatch schema validation', () => {
