...
import { SENSITIVE_ENV_KEY_PATTERN } from '../../../../skills/dispatch/scripts/runners/shared.mjs';
import * as opencodeRunModule from '../../../../skills/dispatch/scripts/runners/opencode.mjs';
import {
  ...
  resolveTargetFrom,
  runOpencode,
} from '../../../../skills/dispatch/scripts/runners/opencode.mjs';
...
describe('opencode-run', () => {
  ...
  describe('main — CLI guard rails', () => {
    ...
    it('exits 1 with the parser message for an unknown flag', () => {
      const script = path.join(PROJECT_ROOT, 'skills', 'dispatch', 'scripts', 'runners', 'opencode.mjs');
